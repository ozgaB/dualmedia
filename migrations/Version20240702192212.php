 ...
 */
final class Version20240702192212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dualmedia_order (id INT AUTO_INCREMENT NOT NULL, price_summary_gross NUMERIC(10, 2) NOT NULL, price_summary_net NUMERIC(10, 2) NOT NULL, price_summary_vat NUMERIC(10, 2) NOT NULL, products_amount INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
